      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4 py-12">
        ...
        <div className="max-w-4xl mb-8">
          <p className="text-lg sm:text-xl md:text-2xl text-blue-100 mb-6 font-light">
            Take part in the <span className="font-semibold text-yellow-300">Nigeria Medical Imaging Survey (NMIS)</span> 
            for a chance to win <span className="font-bold text-yellow-300 mx-1">$500</span>. 
            Your participation will contribute to building a comprehensive GIS database of medical imaging equipment across Nigeria.
          </p>
          ...
          <p className="text-base sm:text-lg md:text-xl text-blue-100 font-light">
            ...
            <em className="block mt-2">A framework for advancing sustainable magnetic resonance imaging access in Africa.</em> 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-10">
            ...
            <div className="text-center p-5 sm:p-6 rounded-xl bg-gradient-to-b from-white to-blue-50 shadow-lg">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-3">Win Prizes</h3>
              <p className="text-gray-900 text-sm sm:text-base">
